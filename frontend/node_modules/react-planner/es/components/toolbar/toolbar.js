    ...
    value: function render() {
      ...
      if(this.props.isAdmin)
      {
        var sorter = [
          ...
          dom: React.createElement(ToolbarLoadButton, {username:this.props.username, isAdmin:this.props.isAdmin, state: state })
        }, {
      ...
      var sorter = [
        {
          ...
          dom: React.createElement(ToolbarButton,{
            tooltip: translator.t('Play'),
            onClick: function onClick(event) {
              if(_state.firstTime)
              {
                ...
                .then(data2 => {
                  ...
                  setInterval(() => {
                    count=count+2;
                    _state.playing?speech.speak({
                      text: playout[count]+playout[count+1],
                    }).then(() => {
                      _this2.state.setState({playing:false});
                        console.log("Success !");
                    }).catch(e => {
                        console.error("An error occurred :", e)
                    }):null},600)
            } },
          _state.playing?React.createElement(FaPlayCircle,null):React.createElement(FaPauseCircle,null)
        )
      },
        {
          index: 2, condition: allowProjectFileSupport,
