    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
              "button",
              {
                ...
                onClick: function onClick() {
                  ...
                  .then(data=>{
                    if(data.deleted)
                    {console.log("Yes, item present");return _this2.toggleDelete();}
                  })
                },
              },
              "Delete"
            ),
            //deleted? React.createElement(Assert,"Hi"):null
          ),
          React.createElement(
            "button",
            {
          ...
          opened?_state.products.map((product)=>React.createElement('p',{},product.description," :",product.currencyAmount,product.currencyUnit)):null
