  ...
  var componentRenderer = function componentRenderer(element, layer) {
    return React.createElement(
      ...
      React.createElement(
        ...
        _ref.isAdmin? React.createElement(ElementEditor, { element: element, layer: layer, state: state }):null,
        React.createElement(DisplayElement,{Id:element.id, opened:false, deleted:false})
      )
    );
  };
